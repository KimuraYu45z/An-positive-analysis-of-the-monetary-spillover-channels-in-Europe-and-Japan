...
\abstract{
    ...
    To this end, I use macroeconomic data of Europe and Japan to analyze how monetary easing policies affect financial markets,
    ...
    However, it goes without saying that the responsibility for any possible errors or assertions in this paper belongs to the author.
}
...
In response to this, the central banks of each country implemented monetary easing policies to purchase government bonds and other assets from the financial markets and lowered their policy interest rates.
